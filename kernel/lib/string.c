...
u8 * strncpy(u8 *dest, u8 *src, u32 count)
{
    __asm__("cld\n"
            "1:\tdecl %2\n\t"
            "js 2f\n\t"
...
u8 * strncat(u8 *dest, u8 *src, u32 count)
{
...
s32 strncmp(u8 *cs, u8 *ct, u32 count)
{
...
u8 * strchr(u8 *s, char c)
{
    register u8 * __res __asm__("%eax");
    __asm__("cld\n\t"
            "movb %%al,%%ah\n"
            "1:\tlodsb\n\t"
            "cmpb %%ah,%%al\n\t"
...
u8 * strrchr(u8 *s, char c)
{
    //register u8 * __res __asm__("%edx");
    u8 * __res;
    __asm__("cld\n\t"
            "movb %%al,%%ah\n"
            "1:\tlodsb\n\t"
...
u32 strspn(u8 *cs, u8 *ct)
{
    //register u8 * __res __asm__("%esi");
     u8 * __res;
    __asm__("cld\n\t"
            "movl %4,%%edi\n\t"
            "repne\n\t"
